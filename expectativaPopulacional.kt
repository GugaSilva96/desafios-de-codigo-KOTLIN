// Desafio
// Desenvolver um programa que determine em quantos anos a população do país A 
// ultrapassará ou igualará a população do país B. 
...
// Cálculo Requerido: O programa deve calcular o número de anos necessários para que a população de A seja igual ou maior que a de B, 
// considerando as taxas de crescimento contínuas.
